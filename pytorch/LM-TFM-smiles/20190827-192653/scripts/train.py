...
parser.add_argument('--data', type=str, default='../data/smiles',
                    help='location of the data corpus')
parser.add_argument('--dataset', type=str, default='smiles',
                    choices=['wt103', 'lm1b', 'enwik8', 'text8', 'smiles'],
                    help='dataset name')
...
def train():
    ...
    for batch, (data, target, seq_len) in enumerate(train_iter):
        ...
        if train_step % args.log_interval == 0:
            ...
            if args.dataset in ['enwik8', 'text8', 'smiles']:
        ...
        if args.scheduler in ['cosine', 'constant', 'dev_perf']:
            ...
            if train_step < args.warmup_step:
                ...
                if args.scheduler == 'cosine':
                    ...
                    if((batch+1)*args.batch_size == 450000):
                        scheduler.step()
